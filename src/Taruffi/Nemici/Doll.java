...
public class Doll  extends MovingEntity implements Collidable{
    ...
    public void getEnemiesImage() {
        try {
            ...
            up2 = ImageIO.read(getClass().getResourceAsStream("/Images/Doll/Doll (2).png"));
            down1 = ImageIO.read(getClass().getResourceAsStream("/Images/Doll/Doll (3).png"));
            down2 = ImageIO.read(getClass().getResourceAsStream("/Images/Doll/Doll (4).png"));
            right1 = ImageIO.read(getClass().getResourceAsStream("/Images/Doll/Doll (5).png"));
            right2 = ImageIO.read(getClass().getResourceAsStream("/Images/Doll/Doll (6).png"));
            left1 = ImageIO.read(getClass().getResourceAsStream("/Images/Doll/Doll (7).png"));
            left2 = ImageIO.read(getClass().getResourceAsStream("/Images/Doll/Doll (8).png"));
            damaged1 = ImageIO.read(getClass().getResourceAsStream("/Images/Doll/Doll (9).png"));
            damaged2 = ImageIO.read(getClass().getResourceAsStream("/Images/Doll/Doll (10).png"));
            dead1 = ImageIO.read(getClass().getResourceAsStream("/Images/Doll/Doll (11).png"));
            dead2 = ImageIO.read(getClass().getResourceAsStream("/Images/Doll/Doll (13).png"));
