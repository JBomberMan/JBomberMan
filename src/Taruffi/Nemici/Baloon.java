...
public class Baloon  extends MovingEntity implements Collidable{
    ...
    public void getEnemiesImage() {
        try {
            ...
            up2 = ImageIO.read(getClass().getResourceAsStream("/Images/Baloon/Baloon (2).png"));
            down1 = ImageIO.read(getClass().getResourceAsStream("/Images/Baloon/Baloon (3).png"));
            down2 = ImageIO.read(getClass().getResourceAsStream("/Images/Baloon/Baloon (4).png"));
            right1 = ImageIO.read(getClass().getResourceAsStream("/Images/Baloon/Baloon (5).png"));
            right2 = ImageIO.read(getClass().getResourceAsStream("/Images/Baloon/Baloon (6).png"));
            left1 = ImageIO.read(getClass().getResourceAsStream("/Images/Baloon/Baloon (7).png"));
            left2 = ImageIO.read(getClass().getResourceAsStream("/Images/Baloon/Baloon (8).png"));
            damaged1 = ImageIO.read(getClass().getResourceAsStream("/Images/Baloon/Baloon (9).png"));
            damaged2 = ImageIO.read(getClass().getResourceAsStream("/Images/Baloon/Baloon (10).png"));
            dead1 = ImageIO.read(getClass().getResourceAsStream("/Images/Baloon/Baloon (11).png"));
            dead2 = ImageIO.read(getClass().getResourceAsStream("/Images/Baloon/Baloon (13).png"));
