...
public class Oneal  extends MovingEntity implements Collidable{
    ...
    public void getEnemiesImage() {
        try {
            ...
            up2 = ImageIO.read(getClass().getResourceAsStream("/Images/Oneal/Oneal (2).png"));
            down1 = ImageIO.read(getClass().getResourceAsStream("/Images/Oneal/Oneal (3).png"));
            down2 = ImageIO.read(getClass().getResourceAsStream("/Images/Oneal/Oneal (4).png"));
            right1 = ImageIO.read(getClass().getResourceAsStream("/Images/Oneal/Oneal (5).png"));
            right2 = ImageIO.read(getClass().getResourceAsStream("/Images/Oneal/Oneal (6).png"));
            left1 = ImageIO.read(getClass().getResourceAsStream("/Images/Oneal/Oneal (7).png"));
            left2 = ImageIO.read(getClass().getResourceAsStream("/Images/Oneal/Oneal (8).png"));
            damaged1 = ImageIO.read(getClass().getResourceAsStream("/Images/Oneal/Oneal (9).png"));
            damaged2 = ImageIO.read(getClass().getResourceAsStream("/Images/Oneal/Oneal (10).png"));
            dead1 = ImageIO.read(getClass().getResourceAsStream("/Images/Oneal/Oneal (11).png"));
            dead2 = ImageIO.read(getClass().getResourceAsStream("/Images/Oneal/Oneal (13).png"));
