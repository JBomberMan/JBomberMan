...
public class ETileManager {
    ...
    public void getTileImage(){
        try{
            ...
            tile[7] = new Tile();
            tile[7].immagine = ImageIO.read(getClass().getResourceAsStream("/Images/BomberMan_down1.png"));
            tile[9] = new Tile();
            tile[9].immagine = ImageIO.read((getClass().getResourceAsStream("/Images/Oneal/Oneal (1).png")));
            tile[10] = new Tile();
            tile[10].immagine = ImageIO.read(getClass().getResourceAsStream("/Images/baloon/baloon (1).png"));
            tile[11] = new Tile();
            tile[11].immagine = ImageIO.read(getClass().getResourceAsStream("/Images/kondoria/kondoria (1).png"));
            tile[12] = new Tile();
            tile[12].immagine = ImageIO.read(getClass().getResourceAsStream("/Images/doll/doll (1).png"));
            tile[13] = new Tile();
            tile[13].immagine = ImageIO.read(getClass().getResourceAsStream("/Images/ovapi/ovapi (1).png"));
            tile[14] = new Tile();
